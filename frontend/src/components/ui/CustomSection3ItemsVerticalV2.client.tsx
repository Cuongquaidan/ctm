...
interface CustomSection3ItemsVerticalV2ClientProps<T> {
  items?: T[],
  url?: string,
  title?: string,
  description?: string,
...
function CustomSection3ItemsVerticalV2Client<T>({
  items,
  title,
  description,
  link,
  ...
  isLoop,
  breakpoints
}: CustomSection3ItemsVerticalV2ClientProps<T>) {
...
export default CustomSection3ItemsVerticalV2Client