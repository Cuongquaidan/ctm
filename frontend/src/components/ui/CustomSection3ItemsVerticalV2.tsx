...
interface CustomSection3ItemsVerticalV2Props<T> {
  items?: T[],
  url?: string,
  title?: string,
  description?: string,
...
function CustomSection3ItemsVerticalV2<T>({
  items,
  title,
  description,
  link,
  ...
  isLoop,
  breakpoints
}: CustomSection3ItemsVerticalV2Props<T>) {
...
export default CustomSection3ItemsVerticalV2