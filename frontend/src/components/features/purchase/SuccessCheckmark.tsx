...
const StarIcon = ({ delay, className }: { delay: string; className: string }) => (
  <svg
...
function SuccessCheckmark() {
  return (
    <div className="checkmark relative">
      <StarIcon delay="0s" className="top-2 left-2" />
      <StarIcon delay="3s" className="bottom-5 left-5" />
      <StarIcon delay="0.8s" className="bottom-0 right-10" />
      <StarIcon delay="0.4s" className="-top-5 left-0" />
      <StarIcon delay="1s" className="top-10 right-2" />
      <StarIcon delay="2s" className="top-7 left-7" />

      <svg
        className="checkmark__check absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"
        fill="white"
        height="36"
        viewBox="0 0 48 36"
        width="48"
