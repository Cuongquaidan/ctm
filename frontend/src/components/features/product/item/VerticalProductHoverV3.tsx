...
import VerticalProductButtonAddV3 from '@/components/features/product/components/VerticalProductButtonAddV3'
interface VerticalProductHoverV3Props {
  product: ProductT;
  index: number;
  className?: string;
  classNameImg?: string;
...
function VerticalProductHoverV3({ product, index, className, classNameImg }: VerticalProductHoverV3Props) {
    ...
    >
      ...
      <div className="product-detail">
        ...
        <div className='w-100'>
          ...
          <div className="counter-box d-flex align-items-center justify-content-between mt-2 w-100">
            <BoxPrice price={product.prices[0].expense} oldPrice={product.prices[0].price}></BoxPrice>
            <div
              style={{
                position: "absolute",
                bottom: 0,
            ...
            >
              <VerticalProductButtonAddV3 productId={product.id} productPriceId={product.prices[0].product_price_id} stock={product.prices[0].remaining_quantity} isInProcessing={checkIsWithinTimeRange(new Date(product.prices[0].start_date || ""), new Date(product.prices[0].end_date || ""))} />
            </div>
...
export default VerticalProductHoverV3