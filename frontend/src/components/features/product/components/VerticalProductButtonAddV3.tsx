...
function VerticalProductButtonAddV3({ productId, productPriceId, stock, isInProcessing }: { productId: number, productPriceId: number, stock: number, isInProcessing?: boolean }) {
  ...
  return (
    <div className="addtocart_btn add-to-cart-btn-2"
      style={{
        zIndex: 1000,
        height: "43px",
    ...
    >
      ...
      {stock === 0 ? (
        ...
        <div
          className=" addcart-button btn buy-button  tooltip-container"
          onClick={() => {
            if (hasAuth) {
              handleUpdateCart(1);
              setIsAdded(true);
        ...
        >
          ...
          <div className="add-icon" style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
        ...
        <div className="cart_qty qty-box-2 open "
          style={{
            position: "relative",
            width: "100%",
            maxWidth: "100%",
...
export default VerticalProductButtonAddV3