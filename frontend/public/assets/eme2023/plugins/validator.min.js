...
+function ($) {
    ...
    var Validator = function (element, options) {
        ...
        this.$btn = $('button[type="submit"], input[type="submit"], .submitAjax, #btnNextStep, #btnDoneStep')
            .filter('[form="' + this.$element.attr('id') + '"]')
            .add(this.$element.find('input[type="submit"], button[type="submit"], #btnNextStep, #btnDoneStep'))
    ...
    Validator.prototype.showErrors = function ($el) {
        ...
        $group.find('.invalid-tooltip, .invalid-feedback').remove();
